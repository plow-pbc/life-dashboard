...
|---|---|---|---|
| `ICAL_URL` | no | — | Full private ICS URL. Secret. Used when no fresh pushed feed is available; blank → `/api/ical` answers 502. |
